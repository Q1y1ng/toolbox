...
const api = {
  ...
  openDir: (id: string): Promise<LaunchResult> =>
    ipcRenderer.invoke("toolbox:openDir", id),
  copyCommand: (id: string): Promise<LaunchResult> =>
    ipcRenderer.invoke("toolbox:copyCommand", id),
  ...
  icon: (id: string): Promise<string | null> =>
    ipcRenderer.invoke("toolbox:icon", id),
  openDataDir: () => ipcRenderer.invoke("toolbox:openDataDir"),
  showInExplorer: (path: string) =>
    ipcRenderer.invoke("toolbox:showInExplorer", path),
